...
<html lang="en">
    ...
    <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="landing_div">
            ...
            <div class="container">
                <span id="tit">ABOUT TRAVEL HUB</span>
                <div class="row">
                    <div class="img col-md-5">
                        <img src="images/london1.jpg" alt="">
                    </div>
                    <div class="text col-md-7">
                        <p style="text-align: center; font-size: 3em; font-weight: bold;">adsssssss
                        </p>
        ...
        <div class="whole">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p>asdasd<div class="number">12213</div></p>
        ...
        <footer>
            <div class="btn btn1 pack-btn" id="contact">CONTACT US &#8594;</div>
            <div class="row">
                <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1AZkIeTyYs-Mt7hNOJlydLJIKr7gUWnIr" class="col-md-5"></iframe>
