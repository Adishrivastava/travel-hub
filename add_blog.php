...
<html lang="en">
  ...
  <!--  
    <form class="add_new container" action="" method="POST">
        ...
        <label for="author_name">Author name</label><input type="text" class="form-control" name="author_name">
        <label for="author_details">Author details</label><input type="text" name="author_details">
        <label for="blog_title">Blog_title</label><input type="text" name="blog_title">
        <label for="content">Content</label><textarea name="content" id="" cols="30" rows="10"></textarea>
        <button class="btn" name="submit">PUBLISH BLOG</button>
    </form>
    -->
    <div class="topnav">
